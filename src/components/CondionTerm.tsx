...
const ConditionTerm = ({ children, onClick, ...props }: ConditionTermProps) => (
  <div {...props}>
    <div className="grid grid-cols-[30px_1fr] gap-2 items-start z-10">
      <Checkbox.Root
        className="bg-white hover:bg-slate-500 flex h-[30px] w-[30px] items-center justify-center rounded-[4px] border-white border-2 shadow-[0_0_0_2px_10px] outline-none focus:shadow-[0_0_0_2px_black]"
        id="c1"
        type='button'
        onClick={onClick}
      >
